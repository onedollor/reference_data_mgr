    ...
    def process_approved_excel(self, workflow_id: str, excel_path: str):
        ...
        try:
            ...
            result = self.api.process_file_sync(
                processing_config['csv_file_path'],
                processing_config['load_type'],
                processing_config['is_reference_data'],
                table_name=processing_config.get('table_name'),
                format_overrides=processing_config.get('format_overrides', {})
            )
